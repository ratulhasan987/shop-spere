...
// import { AiOutlineSearch, AiOutlineMenu, AiOutlineClose } from 'react-icons/ai'; // Import icons
...
//   return (
//     <header className="flex justify-between items-center md:px-6 px-2 md:py-4 py-2 bg-[#F5F3FF]">
//       {/* Logo */}
//       <div className="flex items-center gap-2">
//         <img src="/images/wf_1.png" alt="wf_1" className="md:w-16 md:h-12 w-10 h-8" />
